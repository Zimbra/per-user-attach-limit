 ...
 * @author vmahajan
 */
public class PerUserAttachmentLimitExtension implements ZimbraExtension {
    ...
    public String getName() {
        return "PerUserAttachmentLimitExtension";
    }
    ...
    public void init() throws ServiceException {
        ExtensionDispatcherServlet.register(this, new PerUserAttachmentLimit());
    }
